...
import by.dosin.first.sorter.impl.ArrayQuickSorter;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

import static org.junit.jupiter.api.Assertions.*;

class ArrayQuickSorterTest {

    private ArrayQuickSorter sorter;

    @BeforeEach
    void setUp() {
        sorter = new ArrayQuickSorter();
    }
    ...
    @Test
    void testSortArrayLargeNumbers() {
        IntArray array = new IntArray(new int[]{1000, 500, 1500, 200});
        IntArray result = sorter.sortArray(array);
        assertArrayEquals(new int[]{200, 500, 1000, 1500}, result.getArray());
    }
}